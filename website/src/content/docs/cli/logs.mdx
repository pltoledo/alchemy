---
title: logs
description: Fetch or follow logs from deployed resources, merged and color-coded by resource.
---
...
Fetch historical logs from deployed resources, or pass `--follow` to stream
...
# Follow Worker and Api in real time
alchemy logs --follow --resource Worker,Api
